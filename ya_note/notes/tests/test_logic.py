...
class TestNoteCreation(TestCase):
    ...
    def test_user_can_create_note(self):
        ...
        notes_start = Note.objects.all()
        current_notes_count = Note.objects.count()
        self.assertEqual(current_notes_count, len(notes_start),
...
class TestNoteEditDelete(TestCase):
    ...
    def test_author_can_delete_note(self):
        ...
        self.assertRedirects(res, reverse('notes:success'))
        self.assertEqual(Note.objects.count(), len(notes_start))
